...
chars = ".,-~:;=!*#$@"  # luminance index (Changing the characters cuz we want to that our dount spins from one point)

# More Explaination : https://www.a1k0n.net/2011/07/20/donut-math.html --> Take looke @ This image : https://www.a1k0n.net/img/perspective.png
...
# def text_display(letter, y_start, x_start):
#     text = font.render(str(letter), True, white)
#     display_surface.blit(text, (x_start, y_start))
...
while run:
    ...
    b = [' '] * screen_size  # Background. Fills with empty space
